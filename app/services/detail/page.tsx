      ...
      <section className="py-20 bg-slate-900">
        <div className="container mx-auto px-6">
          <header className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-3xl text-brand-primary font-bold mb-4">{service.price}</p>
          ...
          <div className="grid lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
            <div className="lg:col-span-2 bg-brand-dark p-8 rounded-lg border border-slate-800">
              ...
              <p className="text-slate-300 leading-relaxed mb-8">{service.longDescription}</p>
            ...
            <aside className="lg:col-span-1 space-y-8">
              <div className="bg-brand-dark p-8 rounded-lg border border-slate-800">
                ...
                <p className="text-slate-300 leading-relaxed">{service.idealFor}</p>
              </div>
