...
import { SERVICE_PACKAGES, ADDON_SERVICES, LAUNCH_PACK_SERVICES, RECURRING_SERVICE } from '../constants';
...
const ServiceCard: React.FC<{ packageInfo: ServicePackage }> = ({ packageInfo }) => {
    const cardClasses = packageInfo.isFeatured 
        ? 'bg-slate-800 border-2 border-brand-primary transform scale-105'
