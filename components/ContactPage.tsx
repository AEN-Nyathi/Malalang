              ...
              <div className="space-y-4 text-slate-300">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@malalang.co.za" className="hover:text-brand-primary transition-colors duration-300">info@malalang.co.za</a>
                  </div>
                </div>
              </div>
            </div>
