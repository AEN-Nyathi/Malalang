  ...
  return (
    <section className="py-20 bg-brand-dark">
      <div className="container mx-auto px-6">
        <div className="bg-gradient-to-r from-brand-primary to-brand-secondary p-8 md:p-12 rounded-lg text-center">
          <h2 className="text-3xl md:text-4xl font-extrabold text-white">Ready to Grow Your Business Online?</h2>
          <p className="text-lg text-slate-100 mt-4 max-w-2xl mx-auto">
            Let's have a chat about your project. No obligations, no pressure, and absolutely no upfront cost.
          </p>
          <div className="mt-8">
            <a 
              href={WHATSAPP_LINK} 
              ...
              className="inline-flex items-center bg-white text-brand-dark font-bold py-4 px-8 rounded-lg text-lg transition-transform transform hover:scale-105 duration-300 shadow-lg"
            >
              <svg className="w-6 h-6 mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor">
